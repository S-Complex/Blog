<template>
    <v-card v-if="path.includes('posts')" class="mx-auto" rounded="0" style="height:400px" color="#BDBDBD">
        <ContentDoc v-slot="{ doc }">
            <v-img height="100%" gradient="rgba(0,0,0,.2), rgba(0,0,0,.2)" cover lazy-src="https://library.restent.win/images/bg.webp" v-bind:src="doc.banner ?? 'https://library.restent.win/images/bg.webp'">
    ...
    <v-card v-else class="mx-auto" rounded="0" width="100%" height="400" color="#BDBDBD">
        <v-img height="100%" cover lazy-src="https://library.restent.win/images/bg.webp" src="https://library.restent.win/images/bg.webp">
