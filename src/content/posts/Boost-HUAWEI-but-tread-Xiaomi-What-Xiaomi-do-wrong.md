...
首先，在不久之前，雷总发布了一个动态，告知「小米澎湃OS」（即 HyperOS）正式诞生，并且还真写明了「它基于 **深度进化的Android** 以及 **自研的Vela系统** 融合，**彻底重写底层架构**」；后面一点他公开了 HyperOS 的系统架构，在「服务与框架层」的最左边就有四个与 Android 相关的部分，那么请问人家都老实巴交了、这位老先生和发这个评论的网友，哪来的证据说人家抛弃安卓了？而且现阶段抛弃安卓，海外市场丢失造成的损失由网友们买单吗？至于为什么海外市场会出现，稍后我会在下文讲述。
